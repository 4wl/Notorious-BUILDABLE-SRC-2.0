...
public class ColorUtil
{
    ...
    public static Color normalizedFade(final float value, final Color startColor, final Color endColor) {
        ...
        final float r = MathHelper.clamp(sr * value + er * (1.0f - value), 0.0f, 1.0f);
        final float g = MathHelper.clamp(sg * value + eg * (1.0f - value), 0.0f, 1.0f);
        final float b = MathHelper.clamp(sb * value + eb * (1.0f - value), 0.0f, 1.0f);
    ...
    public static Color brightenFade(final float value, final Color color) {
        ...
        final float r = MathHelper.clamp(sr * value + er * (4.0f - value), 0.0f, 1.0f);
        final float g = MathHelper.clamp(sg * value + eg * (4.0f - value), 0.0f, 1.0f);
        final float b = MathHelper.clamp(sb * value + eb * (4.0f - value), 0.0f, 1.0f);
        return new Color(r, g, b);
    }
