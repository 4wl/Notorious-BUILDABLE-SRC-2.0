    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.isTyping) {
            if (font.isEnabled()) {
                ...
                Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.setting.getName() + " <" + this.currentString.getString() + ">", this.x + 9.0f, this.y + 1.0f, -1);
            }
        }
            ...
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.setting.getName() + " <" + this.setting.getString() + ">", this.x + 9.0f, this.y + 1.0f, -1);
        }
    }
