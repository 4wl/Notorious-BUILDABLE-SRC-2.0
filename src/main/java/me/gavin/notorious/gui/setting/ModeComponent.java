...
public class ModeComponent extends SettingComponent
{
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (font.isEnabled()) {
            ...
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.setting.getName() + " <" + this.setting.getMode() + ">", this.x + 9.0f, this.y + 1.0f, new Color(255, 255, 255).getRGB());
        }
    }
