...
public class BooleanComponent extends SettingComponent
{
    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawRect(this.x, this.y, this.x + this.width, this.y + this.height, this.setting.isEnabled() ? color : new Color(0, 0, 0, (int)Notorious.INSTANCE.hackManager.getHack(ClickGUI.class).backgroundAlpha.getValue()).getRGB());
        ...
        if (font.isEnabled()) {
            ...
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.setting.getName(), this.x + 9.0f, this.y + 1.0f, new Color(255, 255, 255).getRGB());
        }
    }
