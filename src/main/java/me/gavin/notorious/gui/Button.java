    ...
    public void render(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.open) {
            if (font.isEnabled()) {
                ...
                Button.mc.fontRenderer.drawStringWithShadow("-", this.x + this.width - 8.0f, this.y + 2.0f, new Color(255, 255, 255).getRGB());
            }
        }
        ...
        if (font.isEnabled()) {
            ...
            Button.mc.fontRenderer.drawStringWithShadow(this.hack.getName(), this.x + 2.0f, this.y + 2.0f, this.hack.isEnabled() ? intRainbow : -1);
        }
        if (this.open) {
