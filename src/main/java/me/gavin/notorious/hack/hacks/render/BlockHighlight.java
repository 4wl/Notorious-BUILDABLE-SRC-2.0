...
public class BlockHighlight extends Hack
{
    ...
    public void onRender(final RenderWorldLastEvent event) {
        final RayTraceResult result = BlockHighlight.mc.objectMouseOver;
        ...
        if (result != null && result.typeOfHit == RayTraceResult.Type.BLOCK) {
            final AxisAlignedBB box = BlockHighlight.mc.world.getBlockState(result.getBlockPos()).getSelectedBoundingBox((World)BlockHighlight.mc.world, result.getBlockPos());
            if (result.typeOfHit == RayTraceResult.Type.BLOCK && BlockHighlight.mc.world.getBlockState(result.getBlockPos()).getBlock() != Blocks.AIR) {
