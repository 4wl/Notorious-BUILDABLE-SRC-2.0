...
public class Capeutil
{
    ...
    public static void setCape(final DynamicTexture texture) {
        Capeutil.capeTexture = Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("assets/notorious/capes", texture);
    }
    ...
    static {
        ...
        Capeutil.currentCape = 0;
        try {
            Capeutil.capeTexts.add(Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("assets/notorious/capes", new DynamicTexture(ImageIO.read(new URL("https://i.imgur.com/W1T3gFG.png")))));
            Capeutil.capeTexts.add(Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("assets/notorious/capes", new DynamicTexture(ImageIO.read(new URL("https://i.imgur.com/P0plzkt.png")))));
            Capeutil.capeTexts.add(Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("assets/notorious/capes", new DynamicTexture(ImageIO.read(new URL("https://i.imgur.com/iAEjyYs.png")))));
        }
        catch (Exception ex) {}
